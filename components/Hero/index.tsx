    ...
    return (
        <section className="flex items-center justify-center h-screen relative">
            ...
            <div className="max-w-8xl mx-auto px-6 z-20">
                <div className="flex flex-col lg:flex-row items-center lg:min-h-[600px]">
                    {/* Left: decorative circle with phone mockup */}
                    <div className="relative hidden  w-full lg:w-1/2 md:flex items-center justify-center py-12 lg:py-0">
            ...
            <div className="absolute hidden lg:block bottom-0 bg-[#2f415724] w-full h-40 backdrop-blur-sm rounded-[40px] z-20"  />
        </section>
    );
}
